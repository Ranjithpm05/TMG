      ...
      Push_Data_List: [
        {
          ...
          ShipFrom_Addr1: data.shipFrom?.addr1 || '',
          ShipFrom_Addr2: data.shipFrom?.addr2 || '',
          ShipFrom_Loc: data.shipFrom?.loc || '',
          ShipFrom_Pin: data.shipFrom?.pin || 0,
          ShipFrom_Stcd: data.shipFrom?.stcd || '',

...
export class SalesReportProductWise2Component {
  ...
  // (ever-growing) invoice history on every load — see Format 1's identical
  // comment for why range-querying createdAt is equivalent to filtering by
  // invoiceDate here. Refetches whenever the range or retry trigger changes.
